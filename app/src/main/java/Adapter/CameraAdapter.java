...
import com.example.pj_lab11.OrderFormActivity;
import com.example.pj_lab11.R;

import java.util.List;

import Model.Camera;

public class CameraAdapter extends RecyclerView.Adapter<CameraAdapter
        .ProductViewHolder> {

    private Context context;
    private List<Camera> cameraList;

    public CameraAdapter(Context context, List<Camera> productList) {
        this.context = context;
        this.cameraList = productList;
    }
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        Camera product = cameraList.get(position);
